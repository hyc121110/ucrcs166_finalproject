...
public class DBproject{
    ...
    // id
    do {
      System.out.print("\tPlease input the plane ID: ");
      try {
        id = Integer.parseInt(in.readLine()); // convert string to int
        break;
      } catch (Exception e) {
    ...
    try {
      ...
      int rowCount = esql.executeQuery(query); // lab6
      System.out.println ("total row(s): " + rowCount); // lab6
    } catch (Exception e) {
    ...
    // id
    do {
      System.out.print("\tPlease input the techician ID: ");
      try {
        id = Integer.parseInt(in.readLine()); // convert string to int
        break;
      } catch (Exception e) {
    ...
    try {
      ...
      /*String query = "INSERT INTO Reservation(rnum, cid, fid, status) VALUES (" + rnum + ", " + cid + ", " + fid + ", \'" + status + "\');";
			esql.executeUpdate(query);
      print("Successfully booked flight!");
		} catch (Exception e) {
			System.err.println (e.getMessage());*/
		}
	}
